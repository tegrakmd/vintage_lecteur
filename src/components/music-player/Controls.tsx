...
export const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <>
      {/* Grille haut-parleur */}
      <div className="w-full h-[36px] flex items-center justify-center px-6">
        <div
          className="w-full h-[18px] opacity-40"
          style={{
      ...
      <div
        ...
        style={{
          boxShadow: 'inset 0 4px 10px rgba(0,0,0,0.7), 0 1px 1px rgba(255,255,255,0.06)',
        }}
      >
        <button
          onClick={onPrev}
